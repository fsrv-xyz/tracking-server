...
const (
	IngestService_IngestMessage_FullMethodName = "/proto.IngestService/IngestMessage"
)
...
func (c *ingestServiceClient) IngestMessage(ctx context.Context, in *Request, opts ...grpc.CallOption) (*IngestResponse, error) {
	...
	err := c.cc.Invoke(ctx, IngestService_IngestMessage_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _IngestService_IngestMessage_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: IngestService_IngestMessage_FullMethodName,
	}
